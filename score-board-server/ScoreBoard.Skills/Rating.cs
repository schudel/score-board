...
namespace ScoreBoard.Skills
{
    ...
    public class Rating
    {
        ...
        private readonly double conservativeStandardDeviationMultiplier;
        ...
        /// </summary>
        public double ConservativeRating => Mean - conservativeStandardDeviationMultiplier*StandardDeviation;
