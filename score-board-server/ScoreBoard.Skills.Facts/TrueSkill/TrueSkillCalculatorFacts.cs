...
{
    public static class TrueSkillCalculatorFacts
    {
        ...
        private static void TwoPlayerTestNotDrawn(SkillCalculator calculator)
        {
            ...
            var newRatings = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 2);
            ...
            AssertMatchQuality(0.447, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void TwoPlayerTestDrawn(SkillCalculator calculator)
        {
            ...
            var teams = Teams.Concat(team1, team2);
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatings = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 1);
        ...
        private static void OneOnOneMassiveUpsetDrawTest(SkillCalculator calculator)
        {
            ...
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatingsWinLose = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 1);
            ...
            AssertMatchQuality(0.110, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void TwoOnTwoUnbalancedDrawTest(SkillCalculator calculator)
        {
            ...
            AssertMatchQuality(0.214, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void TwoOnTwoUpsetTest(SkillCalculator calculator)
        {
            ...
            AssertMatchQuality(0.084, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void OneOnTwoSimpleTest(SkillCalculator calculator)
        {
            ...
            AssertMatchQuality(0.135, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void OneOnTwoSomewhatBalanced(SkillCalculator calculator)
        {
            ...
            AssertMatchQuality(0.478, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void OneOnThreeSimpleTest(SkillCalculator calculator)
        {
            ...
            AssertMatchQuality(0.012, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void OneOnSevenSimpleTest(SkillCalculator calculator)
        {
            ...
            AssertMatchQuality(0.000, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void ThreeOnTwoTests(SkillCalculator calculator)
        {
            ...
            var teams = Teams.Concat(team1, team2);
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatingsWinLoseExpected = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 2);
            ...
            AssertMatchQuality(0.254, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void TwoOnFourOnTwoWinDraw(SkillCalculator calculator)
        {
            ...
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatingsWinLose = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 2, 2);
            ...
            AssertMatchQuality(0.367, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void ThreeTeamsOfOneNotDrawn(SkillCalculator calculator)
        {
            ...
            var teams = Teams.Concat(team1, team2, team3);
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatings = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 2, 3);
            ...
            AssertMatchQuality(0.200, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void ThreeTeamsOfOneDrawn(SkillCalculator calculator)
        {
            ...
            var teams = Teams.Concat(team1, team2, team3);
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatings = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 1, 1);
        ...
        private static void FourTeamsOfOneNotDrawn(SkillCalculator calculator)
        {
            ...
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatings = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 2, 3, 4);
            ...
            AssertMatchQuality(0.089, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void FiveTeamsOfOneNotDrawn(SkillCalculator calculator)
        {
            ...
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatings = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 2, 3, 4, 5);
            ...
            AssertMatchQuality(0.040, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void EightTeamsOfOneDrawn(SkillCalculator calculator)
        {
            ...
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatings = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 1, 1, 1, 1, 1, 1, 1);
            ...
            AssertMatchQuality(0.004, calculator.CalculateMatchQuality(gameInfo, teamEnumerable));
        }
        ...
        private static void EightTeamsOfOneUpset(SkillCalculator calculator)
        {
            ...
            var teams = Teams.Concat(team1, team2, team3, team4, team5, team6, team7, team8);
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            var newRatings = calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 2, 3, 4, 5, 6, 7, 8);
        ...
        private static void OneOnTwoBalancedPartialPlay(SkillCalculator calculator)
        {
            ...
            var teams = Teams.Concat(team1, team2);
            IEnumerable<IDictionary<Player, Rating>> teamEnumerable = teams as IDictionary<Player, Rating>[] ?? teams.ToArray();
            calculator.CalculateNewRatings(gameInfo, teamEnumerable, 1, 2);
            calculator.CalculateMatchQuality(gameInfo, teamEnumerable);
        ...
        {
            actual.Mean.Should().BeApproximately(expectedMean, ErrorTolerance);
            actual.StandardDeviation.Should().BeApproximately(expectedStandardDeviation, ErrorTolerance);
        }

        private static void AssertMatchQuality(double expectedMatchQuality, double actualMatchQuality)
        {
            actualMatchQuality.Should().BeApproximately(expectedMatchQuality, 0.0005);
        }
    }
}