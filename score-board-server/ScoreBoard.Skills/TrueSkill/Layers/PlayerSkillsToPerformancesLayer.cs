...
namespace ScoreBoard.Skills.TrueSkill.Layers
{
            ...
            KeyedVariable<TPlayer, GaussianDistribution>>
    {
        ...
        private GaussianLikelihoodFactor CreateLikelihood(Variable<GaussianDistribution> playerSkill,
                                                          Variable<GaussianDistribution> playerPerformance)
        {
        ...
        public override Schedule CreatePosteriorSchedule()
        {
            return ScheduleSequence(
                from likelihood in LocalFactors
